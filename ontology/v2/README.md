...
ontology/v2/
  modules/
    ...
    hcm-placeholders.ttl  # 14 UNKNOWN:/ns: terms still awaiting definition-or-drop (T4/T5)
...
tech 4; 14 placeholders isolated. All files parse clean.
...
- **14 placeholders** in `hcm-placeholders.ttl` — define or drop (T4), then add
