...
def bind_prefixes(g: Graph, manifest: dict) -> None:
    ...
    g.bind("hcm-bio", Namespace("https://w3id.org/hcm/bio/"), replace=True)
    g.bind("hcm-env", Namespace("https://w3id.org/hcm/env/"), replace=True)
    g.bind("hcm-obs", Namespace("https://w3id.org/hcm/obs/"), replace=True)
