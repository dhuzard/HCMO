...
Git repository and the Zenodo deposit (download), with HTML documentation served via GitHub Pages. No hosted SPARQL service is part of 0.3.0; the distributions can be loaded into any standards-compliant local or hosted triple store.
