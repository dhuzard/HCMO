...
| **F2** Rich metadata | `owl:Ontology` header (creators, version, license); WIDOCO | header, docs site | Definitions complete; expert wording review remains ongoing |
...
| **R1** Rich, accurate attributes | labels/comments, provenance | modules | Definitions complete; review with domain experts |
