...
| 4 | **Resource description** | 2.5 | MAPP framework; modules (core/bio/env/obs); key classes (MonitoredEnclosure, Subject, observations, Sensor/Hardware/Software) & properties; standards reuse & alignments (SOSA/SSN, OWL-Time, PROV, BFO); JSON-LD context. Figure: ontology overview. |
