...
| T8 | Run **quality evaluation**: OOPS!, FOOPS! (FAIR), reasoner (HermiT/ELK), pySHACL, CQ results — archive reports | ◐ | Protege 5.6.9 opens `ontology/v2/hcmo-v2-merged-clean.owl`; HermiT passes with 33 named classes and 0 inconsistent classes. FOOPS v0.4.0 improved from 0.49444446 to 1.0 after metadata, definition, and logo fixes. OOPS! was rerun post-FOOPS on the 966-triple clean v2 artifact; P04/P08/P12/P34 are fixed and P11 is reduced to 59. A 2026-07-15 local follow-up on the 1212-triple artifact reduces the local P11-like count to 31; official OOPS rerun still needs manual/public execution. SHACL/CQ deferred until v2 promotion. See `docs/paper/PROTEGE-REASONER.md`, `docs/paper/FOOPS-REPORT-2026-07-09.md`, and `docs/paper/evaluation/OOPS-REPORT-2026-07-10.md`. |
...
| Date | Change | By |
|------|--------|----|
| 2026-07-15 | **OOPS local follow-up** — added legacy-backed disjointness, one SOSA inverse pair, symmetric `communicatesWith`, and additional conservative domain/range axioms; HermiT and repo validation still pass on the 1212-triple clean v2 artifact; local domain/range check now reports 31 remaining properties pending official OOPS rerun. | Codex |
