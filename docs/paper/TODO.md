...
|----|------|--------|-------|
| T4 | Replace/remove **Chowlk placeholders** (`UNKNOWN:*`, `ns:Class2`, `ns:objectProperty`, `xsd:boolean/integer` as properties) | ◐ | v2 placeholders reduced from 32 to 20; safe core duplicates and obvious tech metadata terms resolved. Decision table: `docs/paper/PLACEHOLDER-MAP.md`. |
