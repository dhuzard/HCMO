...
| T8 | Run **quality evaluation**: OOPS!, FOOPS! (FAIR), reasoner (HermiT/ELK), pySHACL, CQ results — archive reports | ◐ | Protege 5.6.9 opens `ontology/v2/hcmo-v2-merged-clean.owl`; HermiT passes with 33 classes and 0 inconsistent classes. FOOPS v0.4.0 improved from 0.49444446 to 1.0 after metadata, definition, and logo fixes. OOPS! was rerun post-FOOPS on the 803-triple clean v2 artifact; P04/P08/P12/P34 are fixed, P11 is reduced to 87, while P10/P11/P13/P22 remain documented modeling-policy findings. SHACL/CQ deferred until v2 promotion. See `docs/paper/PROTEGE-REASONER.md`, `docs/paper/FOOPS-REPORT-2026-07-09.md`, and `docs/paper/evaluation/OOPS-REPORT-2026-07-10.md`. |
...
| 2026-07-10 | **OOPS post-FOOPS evaluation archived** — rebased the OOPS evaluation branch on the FOOPS/logo `main`, corrected safe OOPS findings, added conservative domain/range axioms, reran OOPS on the 803-triple clean v2 artifact, and archived the XML plus a triaged Markdown report. | Codex |
