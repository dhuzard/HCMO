...
| T5 | Add **labels + `rdfs:comment`/IAO definitions** for all terms | ☐ | FOOPS on v2 found definitions for 0/111 assessed terms; add author-reviewed `rdfs:comment`/IAO definitions in `ontology/v2/modules/*.ttl` before promotion. Do not fabricate definitions from labels. |
