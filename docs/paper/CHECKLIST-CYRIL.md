...
| 20 | Évaluation | Bilan OOPS!/FOOPS!/SHACL/WIDOCO/HermiT | Oui | 🟡 | `sections/06-evaluation.md`, `docs/paper/PROTEGE-REASONER.md`, `docs/paper/FOOPS-REPORT-2026-07-09.md` | WIDOCO ✅; HermiT ✅; FOOPS ✅ (1.0); OOPS! à exécuter; SHACL reporté jusqu'au gel/promotion des termes v2. |
