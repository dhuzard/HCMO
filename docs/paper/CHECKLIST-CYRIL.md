...
| 12 | Ontologie | Vérifier modules Turtle/OWL exportés | Oui | ✅ | `ontology/v2/README.md`, `ontology/v2/hcmo-v2-merged-clean.owl`, `docs/paper/PROTEGE-REASONER.md` | Modules v2 + clean OWL parsés; HermiT passe avec 38 classes et 0 classe incohérente. Live build/CI à repointer à la promotion. |
...
| 20 | Évaluation | Bilan OOPS!/FOOPS!/SHACL/WIDOCO/HermiT | Oui | 🟡 | `sections/06-evaluation.md`, `docs/paper/PROTEGE-REASONER.md`, `docs/paper/FOOPS-REPORT-2026-07-09.md`, `docs/paper/evaluation/OOPS-REPORT-2026-07-10.md` | WIDOCO ✅; HermiT ✅; FOOPS ✅ (1.0); OOPS! ✅ report XML archivé, plus de critique/important; seul P13 mineur documenté; SHACL reporté jusqu'au gel/promotion des termes v2. |
