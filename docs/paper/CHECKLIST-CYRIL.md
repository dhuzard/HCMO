...
| 13 | Ontologie | Nettoyer termes Chowlk temporaires | Oui | 🟡 | `docs/paper/PLACEHOLDER-MAP.md`, `ontology/v2/modules/hcm-placeholders.ttl` | v2 réduit à 20 placeholders; doublons sûrs et tech metadata résolus. Reste à mint/drop les termes listés avant promotion. |
