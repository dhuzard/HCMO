...
| 13 | Ontologie | Nettoyer termes Chowlk temporaires | Oui | 🟡 | `docs/paper/PLACEHOLDER-MAP.md`, `ontology/v2/modules/hcm-placeholders.ttl` | v2 réduit à 15 placeholders; doublons sûrs, tech metadata et light-cycle env terms résolus. Reste à mint/drop les termes listés avant promotion. |
